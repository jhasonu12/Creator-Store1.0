  ...
  return (
    <div className="flex gap-3 w-full">
      <button
        ...
        className="flex-1 flex items-center justify-center gap-2.5 rounded-lg p-3.5 bg-white dark:bg-slate-800 border-2 border-blue-200 dark:border-blue-800/50 hover:border-blue-400 dark:hover:border-blue-600 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20 group"
