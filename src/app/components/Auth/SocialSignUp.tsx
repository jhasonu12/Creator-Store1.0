  ...
  return (
    <div className="flex gap-3 w-full">
      <button
        ...
        className="flex-1 flex items-center justify-center gap-2.5 rounded-lg p-3.5 bg-white dark:bg-slate-800 border-2 border-purple-200 dark:border-purple-800/50 hover:border-purple-400 dark:hover:border-purple-600 text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 font-medium transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 group"
      ...
      <button
        ...
        className="flex-1 flex items-center justify-center gap-2.5 rounded-lg p-3.5 bg-white dark:bg-slate-800 border-2 border-pink-200 dark:border-pink-800/50 hover:border-pink-400 dark:hover:border-pink-600 text-gray-700 dark:text-gray-300 hover:text-pink-600 dark:hover:text-pink-400 font-medium transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/20 group"
